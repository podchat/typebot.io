      ...
      <Container style={container}>
        ...
        <Section style={featureSection}>
          ...
          <Text style={text}>
            ...
            <br />
            <br />🧠 Tools / functions support in OpenAI block
            <br />
            <br />🔒 New "Allowed origins" typebot settings to make sure your
            typebot can only be ran from your domain.
            <br />
            <br />
            ...
            <br />
            <br />
            👨‍💻 You can now use the `setVariable` function in any custom code
            to set the value of a specific variable.
          </Text>
        </Section>
